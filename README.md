...
<table>
  <tr>
    <td align="center" width="25%"><img src="./pics/S0.jpg" alt="S0 加载 skill" width="100%"><br>S0 加载 skill</td>
    <td align="center" width="25%"><img src="./pics/S1A.jpg" alt="S1A 执行功能 1" width="100%"><br>S1A 执行功能 1</td>
    <td align="center" width="25%"><img src="./pics/S1B.jpg" alt="S1B 执行功能 2" width="100%"><br>S1B 执行功能 2</td>
    <td align="center" width="25%"><img src="./pics/S1C.jpg" alt="S1C 执行功能 3" width="100%"><br>S1C 执行功能 3</td>
  </tr>
</table>

<table>
  <tr>
    <td align="center" width="33%"><img src="./pics/S2A_html_output.jpg" alt="功能 1 HTML 输出截图" width="100%"><br>功能 1 HTML 输出</td>
    <td align="center" width="33%"><img src="./pics/S2B_html_output.jpg" alt="功能 2 HTML 输出截图" width="100%"><br>功能 2 HTML 输出</td>
    <td align="center" width="33%"><img src="./pics/S2C_html_output.jpg" alt="功能 3 HTML 输出截图" width="100%"><br>功能 3 HTML 输出</td>
  </tr>
</table>

<table>
  <tr>
    <td align="center" width="33%"><img src="./pics/S2A_pdf_output.jpg" alt="功能 1 PDF 输出截图" width="100%"><br>功能 1 PDF 输出</td>
    <td align="center" width="33%"><img src="./pics/S2B_pdf_output.jpg" alt="功能 2 PDF 输出截图" width="100%"><br>功能 2 PDF 输出</td>
    <td align="center" width="33%"><img src="./pics/S2C_pdf_output.jpg" alt="功能 3 PDF 输出截图" width="100%"><br>功能 3 PDF 输出</td>
  </tr>
</table>
...
Here, this skill is offered as a gift to Celeste Qu, luyuan Qu, and Yaodong Luo. May your children be admitted to universities they are truly happy with.
...
<table>
  <tr>
    <td align="center" width="25%"><img src="./pics/S0.jpg" alt="S0 load skill" width="100%"><br>S0 Load skill</td>
    <td align="center" width="25%"><img src="./pics/S1A.jpg" alt="S1A run feature 1" width="100%"><br>S1A Run feature 1</td>
    <td align="center" width="25%"><img src="./pics/S1B.jpg" alt="S1B run feature 2" width="100%"><br>S1B Run feature 2</td>
    <td align="center" width="25%"><img src="./pics/S1C.jpg" alt="S1C run feature 3" width="100%"><br>S1C Run feature 3</td>
  </tr>
</table>

<table>
  <tr>
    <td align="center" width="33%"><img src="./pics/S2A_html_output.jpg" alt="Feature 1 HTML output screenshot" width="100%"><br>Feature 1 HTML output</td>
    <td align="center" width="33%"><img src="./pics/S2B_html_output.jpg" alt="Feature 2 HTML output screenshot" width="100%"><br>Feature 2 HTML output</td>
    <td align="center" width="33%"><img src="./pics/S2C_html_output.jpg" alt="Feature 3 HTML output screenshot" width="100%"><br>Feature 3 HTML output</td>
  </tr>
</table>

<table>
  <tr>
    <td align="center" width="33%"><img src="./pics/S2A_pdf_output.jpg" alt="Feature 1 PDF output screenshot" width="100%"><br>Feature 1 PDF output</td>
    <td align="center" width="33%"><img src="./pics/S2B_pdf_output.jpg" alt="Feature 2 PDF output screenshot" width="100%"><br>Feature 2 PDF output</td>
    <td align="center" width="33%"><img src="./pics/S2C_pdf_output.jpg" alt="Feature 3 PDF output screenshot" width="100%"><br>Feature 3 PDF output</td>
  </tr>
</table>
